...
pander(t.test(UVindex~Robot,data=UVindex[which(UVindex$AgeGroup==3),]))

pander(t.test(UVindex~Robot,data=UVindex[which(UVindex$AgeGroup==4),]))

#regression analyses to predict creepiness factor
lm.out = lm(UVindex.cent~Agency.cent+Exp.cent+Age+Robot+Agency.cent*Age+Exp.cent*Age+Robot*Age,
            data=UVindex)
...
pander(summary(lm(UVindex.cent~Mind.cent+Age+Robot+Mind.cent*Age,
                  data=UVindex)))
