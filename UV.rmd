...
# version = '2.5'
# request = 'getLegacyResponseUV'
# username = 'kabrink%23umich'
# token = 'EV1NOq9slwpxgpJuZuOoUl8c9hjmqUGGNPDEz95A'
# format = 'CSV'
# surveyID = 'SV_8kWd7cXI2WEzUVf'
# exportTags = '1'
# UnansweredRecode = '-99'
# 
# getSurveyResults <- function (version, request, username, token, format, surveyid)
# {
...
# }
# 
# qualtrics.UV <- getSurveyResults(version, request, username, token, format, surveyid)
```

```{r calculate_variables}
UV$Age = (year(as.period(new_interval(UV$DOB, UV$DOT)))*12) + month(as.period(new_interval(UV$DOB, UV$DOT))) + (day(as.period(new_interval(UV$DOB, UV$DOT)))/30)
